...
- [x] **ENG-03**: Binary search on DPI (30-300) finds highest quality that fits under target size
- [x] **ENG-04**: Binary search on DPI finds highest quality that achieves target % reduction
- [x] **ENG-05**: Files already under target size are skipped (not recompressed)
- [x] **ENG-06**: Emscripten virtual filesystem is cleaned between files to prevent state leaks
